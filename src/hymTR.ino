...
void konfigurasyonYazdir()
{
  ...
  */
  ...
  DEBUG_PORT.print(F("  GPS Var/Yok : "));  
  DEBUG_PORT.println(Ayarlar.gps_varyok);
  DEBUG_PORT.print(F("Koor.Latitude : "));  
  DEBUG_PORT.println(Ayarlar.latitude);
  DEBUG_PORT.print(F("Koor.Longitude: "));  
  DEBUG_PORT.println(Ayarlar.longitude);
  DEBUG_PORT.print(F("Koor.Altitude : "));  
  DEBUG_PORT.println(Ayarlar.altitude);
  DEBUG_PORT.print(F("   PGH(Power) : "));  
  DEBUG_PORT.println(Ayarlar.power);
  DEBUG_PORT.print(F("    PGH(Gain) : "));  
  DEBUG_PORT.println(Ayarlar.gain);
  DEBUG_PORT.print(F("  PGH(Height) : "));  
  DEBUG_PORT.println(Ayarlar.height);
  DEBUG_PORT.print(F(" PGH(Direct.) : "));  
  DEBUG_PORT.println(Ayarlar.directivity);
...
void VarsayilanAyarlar() {
  ...
  Ayarlar.gain = 1;
  Ayarlar.height = 1;
  Ayarlar.directivity = 1;
  Ayarlar.CheckSum = 367;  //iZCi icin Checksum degeri
  eepromaYaz();
}
...
bool seridenAl() {
  ...
  while (!DEBUG_PORT.available()) { } //veri gelmesini bekle
    if (DEBUG_PORT.read() == 0x01) {
      ...
      //Latitude
      parametreOku(szParam, sizeof(szParam));
      strcpy(Ayarlar.latitude,szParam);

      //Longitude
      parametreOku(szParam, sizeof(szParam));
      strcpy(Ayarlar.longitude,szParam);

      //Altitude
      parametreOku(szParam, sizeof(szParam));
      strcpy(Ayarlar.altitude,szParam);

      //parametreOku(szParam, sizeof(szParam));
      //Ayarlar.power = atoi(szParam);    

      //parametreOku(szParam, sizeof(szParam));
      //Ayarlar.gain = atoi(szParam);    

      //parametreOku(szParam, sizeof(szParam));
      //Ayarlar.height = atoi(szParam);    

      //parametreOku(szParam, sizeof(szParam));
      //Ayarlar.directivity = atoi(szParam);    
...
void seriyeGonder() {
        ...
        DEBUG_PORT.print(F(",'GPSvar_yok':"));
        DEBUG_PORT.print(Ayarlar.gps_varyok, DEC);      
        DEBUG_PORT.print(F(",'latitude':'"));
        DEBUG_PORT.print(Ayarlar.latitude);      
        DEBUG_PORT.print(F("','longitude':'"));
        DEBUG_PORT.print(Ayarlar.longitude);      
        DEBUG_PORT.print(F("','altitude':'"));
        DEBUG_PORT.print(Ayarlar.altitude);      
        DEBUG_PORT.print(F("','power':"));
        DEBUG_PORT.print(Ayarlar.power,DEC);      
        DEBUG_PORT.print(F(",'gain':"));
        DEBUG_PORT.print(Ayarlar.gain,DEC);      
        DEBUG_PORT.print(F(",'height':"));
        DEBUG_PORT.print(Ayarlar.height,DEC);      
        DEBUG_PORT.print(F(",'directivity':"));
        DEBUG_PORT.print(Ayarlar.directivity,DEC);      
